    ...
    return Scaffold(
      ...
      body: Container(
        ...
        margin: EdgeInsets.only(
            left: Adapt.px(16), right: Adapt.px(16), top: Adapt.px(56)),
          ...
          children: [
            InkWell(
              ...
              onTap: () async {
                ...
                final isSuccess = await YLModuleService.invoke(
                    "yl_wowchat", "deleteAccount", [
                  YLUserInfoManager.sharedInstance.currentUserInfo?.userId ?? ''
                ]);
                YLUserInfoManager.sharedInstance.logout();
                YLNavigator.popToRoot(context);
            ...
            InkWell(
              ...
              child: createRow(
                  isRightTitle: false,
                  isRightImage: false,
                  leftTitle: Localized.text('yl_usercenter.Logout'),
                  rightTitle: '',
                  rightIconName: ''),
              onTap: () async {
                YLUserInfoManager.sharedInstance.logout();
