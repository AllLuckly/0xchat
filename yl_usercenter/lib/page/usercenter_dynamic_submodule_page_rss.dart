...
class UsercenterDynamicSubmoduleRssPage extends StatefulWidget {
  DynamicSubmodulePageType? pageType;
  UsercenterDynamicSubmoduleRssPage({Key? key, this.pageType}) : super(key: key);

  @override
  State<UsercenterDynamicSubmoduleRssPage> createState() => _UsercenterDynamicSubmoduleRssPageState();
}

class _UsercenterDynamicSubmoduleRssPageState extends State<UsercenterDynamicSubmoduleRssPage>  with AutomaticKeepAliveClientMixin{
  DynamicSubmodulePageType? pageType;
  MyPreGod? preGod;
  ...
  void _getAccountInfoFn() async {
    ...
    preGod = await getMyPreGods(
      params:params2,
      account: /*YLUserInfoManager.sharedInstance.currentUserInfo?.token ?? */'0x4f714880A5847D335606bb37848CcAcbcD6d5836'
    );
    LogUtil.e("Michael=============xxxxxxxxxxxxxxx : ${preGod}=====${preGod!.list!}");
    if(preGod != null){
